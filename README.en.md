...
- `current_input_file`: the only active split mode; it is disabled by default and uploads the full context as a hidden context file once the character threshold is reached.
