...
func (streamStatusAuthStub) BanCurrentAccount(_ *auth.RequestAuth, _ time.Duration) {}
...
func (streamStatusManagedAuthStub) BanCurrentAccount(_ *auth.RequestAuth, _ time.Duration) {}
